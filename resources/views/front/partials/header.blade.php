    ...
    <div class="header-top border-bottom py-2">
      <div class="container-lg">
        <div class="row justify-content-evenly align-items-center">
          ...
          <div class="col">
            <ul class="d-flex justify-content-end gap-3 list-unstyled m-0 align-items-center">
              <li>
                <a href="#">Contact</a>
              </li>
              <li>
               <button class="btn" id="cart_btn"> <a href="#">Cart</a></button>
              </li>
              <li>
                <button id="login_btn" class="btn"><a href="{{ url('/user/login')}}">Login</a></button>
              </li>
            </ul>
          </div>
        </div>
